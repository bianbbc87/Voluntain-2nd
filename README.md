...
│
├── src/ : 백엔드
│   ├── main/ : db model, api 관련 정보 폴더
│   │   └── java/org/donnguk/camputhon : 메인 자바 어플리케이션 보관 폴더
│   │       └── Repository/ : api 설정 파일 (api request에 따른 handler 지정)
│   │           ├── ShortRepository : Short 도메인 레포지토리
│   │           ├── TestRepository : test용 레포지토리
│   │           ├── UserRepository : User 도메인 레포지토리
│   │       └── apiPayload/ : Response type 정의 폴더
│   │           └── code/ : code response 타입 선언 폴더
│   │               └── status/ : success, error 경우의 수
│   │           └── exception/ : 예외처리 정의 폴더
|   │               └── handler/ : 예외처리 핸들러 폴더
│   │               ├── GeneralException : 공통 예외처리 폴더
│   │               ├── ExceptionAdvice : User 도메인 레포지토리 폴더
|   │                   └── AppHandler/ : 앱 서비스용 핸들러 템플릿
│   │           ├── UserRepository : User 도메인 레포지토리
│   │           ├── ApiResponse: ApiResponse 컴포넌트 정의 폴터
│   │       └── config/ : 설정 파일 정의 폴더
│   │       └── controller/ : 컨트롤러 매핑 폴더
│   │       └── domain/ : 도메인 설정 폴더
│   │       └── dto/ : dto 정의 폴더
│   │       └── dto/ : service 로직 구현 폴더
│   │       ├── CamputhonApplication.java : 메인 자바 어플리케이션
│   ├── test/ : 서버, 데이터베이스 관련 정보 폴더
│   │   └── java/org/dongguk/camputhon : test용 자바 어플리케이션 보관 폴더
│   │       ├── CamputhonApplicationTEsts.java : test용 자바 어플리케이션
│
└── 
└
└
